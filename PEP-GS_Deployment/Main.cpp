...
#include <PEP-GS_Deployment/Top/PEP-GS_DeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    PEP-GS_Deployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    PEP-GS_Deployment::TopologyState inputs;
    ...
    PEP-GS_Deployment::setupTopology(inputs);
    PEP-GS_Deployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    PEP-GS_Deployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
