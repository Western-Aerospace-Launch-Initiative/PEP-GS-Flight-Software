// ======================================================================
// \title  PEP-GS_DeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <PEP-GS_Deployment/Top/PEP-GS_DeploymentTopologyAc.hpp>
#include <PEP-GS_Deployment/Top/PEP-GS_DeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(PEP-GS_DeploymentPacketsPkts, PEP-GS_DeploymentPacketsIgnore, 1);
}

// Public functions for use in main program are namespaced with deployment name PEP-GS_Deployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        PEP-GS_Deployment::blockDrv.callIsr();
