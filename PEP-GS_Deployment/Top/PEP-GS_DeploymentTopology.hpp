// ======================================================================
// \title  PEP-GS_DeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef PEP-GS_DEPLOYMENT_PEP-GS_DEPLOYMENTTOPOLOGY_HPP
#define PEP-GS_DEPLOYMENT_PEP-GS_DEPLOYMENTTOPOLOGY_HPP
// Included for access to PEP-GS_Deployment::TopologyState and PEP-GS_Deployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <PEP-GS_Deployment/Top/PEP-GS_DeploymentTopologyDefs.hpp>

// Remove unnecessary PEP-GS_Deployment:: qualifications
using namespace PEP-GS_Deployment;
namespace PEP-GS_Deployment {
/**
 ...
 * PEP-GS_Deployment::TopologyState see: PEP-GS_DeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type PEP-GS_Deployment::TopologyState see: PEP-GS_DeploymentTopologyDefs.hpp.
 *
