...
#include <PEP-GS_Main/Top/PEP-GS_MainTopology.hpp>
...
static void signalHandler(int signum) {
    PEP-GS_Main::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    PEP-GS_Main::TopologyState inputs;
    ...
    PEP-GS_Main::setupTopology(inputs);
    PEP-GS_Main::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    PEP-GS_Main::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
