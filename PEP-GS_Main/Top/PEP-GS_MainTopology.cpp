// ======================================================================
// \title  PEP-GS_MainTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <PEP-GS_Main/Top/PEP-GS_MainTopologyAc.hpp>
#include <PEP-GS_Main/Top/PEP-GS_MainPacketsAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(PEP-GS_MainPacketsPkts, PEP-GS_MainPacketsIgnore, 1);
}

// Public functions for use in main program are namespaced with deployment name PEP-GS_Main
