...
namespace PEP_GS_Main {
  ...
  const Svc::TlmPacketizerPacketList PEP_GS_MainPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  const Svc::TlmPacketizerPacket PEP_GS_MainPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };
